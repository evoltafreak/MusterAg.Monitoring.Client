CREATE VIEW v_UsagePerPod
AS
SELECT d.idDevice, cu.firstname, cu.lastname, p.description as POD, d.description as Device, c.Description as Category, d.maxcapacity, ((Select count(*) FROM networkinterface n WHERE n.fidDevice = d.idDevice)* 100 / d.maxcapacity) as occSlots 
