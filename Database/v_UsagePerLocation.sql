...
AS
SELECT d.idDevice, l.address, l.addressNr, l.fidPlace, d.description, d.maxcapacity, ((Select count(*) FROM networkinterface n WHERE n.fidDevice = d.idDevice)* 100) as occSlots 
